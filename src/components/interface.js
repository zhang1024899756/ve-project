...
class CmdWindow extends React.Component {
  ...
  componentDidMount () {
    const _style = {
      ...
      this.refs.myTitleBar.onmousedown = (e) => {
      this.setState({
      ...
      this.refs.myTitleBar.onmousemove = (e) => {
      ...
      this.refs.myTitleBar.onmouseup = (e) => {
      e.preventDefault();
      this.setState({
          isDragging:false,
          clientx:null,
      ...
      this.refs.myTitleBar.onmouseleave = () => {
      this.setState({isDragging:false});
    }
    this.state.output.push(
    ...
    return(
      <div style={_style.pannel}>
        <div style={_style.myWindow}>
          <TitleBar ref="myTitleBar" background={'white'} theme={'light'} title="管理员:命令提示符" controls/>
...
class InterWindow extends React.Component {
  ...
  render () {
    ...
    return(
      <div style={_style.pannel}>
        <div style={_style.myWindow}>
          <TitleBar ref="myTitleBar" background={'white'} theme={'light'} title="网络连接" controls/>
...
class IpWindow extends React.Component {
  ...
  render () {
    ...
    return(
      <div style={_style.pannel}>
        <div style={_style.myWindow}>
          <TitleBar ref="myTitleBar" background={'white'} theme={'light'} title="Internent（TCP/IPv4）属性" controls/>
          <div style={{padding:'10px'}}>
